  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: "h-7 w-7 inline-flex items-center justify-center bg-transparent border border-slate-200 rounded-lg opacity-60 hover:opacity-100 hover:bg-slate-50 transition-all absolute left-0",
        button_next: "h-7 w-7 inline-flex items-center justify-center bg-transparent border border-slate-200 rounded-lg opacity-60 hover:opacity-100 hover:bg-slate-50 transition-all absolute right-0",
        month_grid: "w-full border-collapse",
        weekdays: "flex justify-between",
        weekday: "text-muted-foreground w-9 font-normal text-[0.8rem] text-center",
        week: "flex w-full mt-2 justify-between",
        day: "h-9 w-9 text-center text-sm p-0 relative focus-within:relative focus-within:z-20",
        day_button: "h-9 w-9 inline-flex items-center justify-center p-0 font-normal rounded-md aria-selected:opacity-100 hover:bg-blue-50 hover:text-blue-600 transition-all",
